...
const categories = [
    ...
    { name: "Medicines", count: 45 },
    { name: "Vitamins", count: 32 },
    { name: "Personal Care", count: 18 },
    { name: "Medical Equipment", count: 12 },
    { name: "Baby Care", count: 13 },
];

const SidebarFilters = () => {
    const { filters, setCategory, setPriceRange } = useGlobalContext();
    ...
    return (
        <aside className="w-full space-y-6">
            ...
            {/* --- PRICE RANGE --- */}
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                <h3 className="font-bold text-slate-800 mb-5 text-sm uppercase tracking-wide">Price Range</h3>
            ...
            <div className="bg-gradient-to-br from-[#4fc3f7] to-[#66bb6a] rounded-2xl p-6 text-white text-center relative overflow-hidden shadow-lg group">
                ...
                <h4 className="font-bold text-xl mb-2 relative z-10">Weekend Sale!</h4>
                <p className="text-xs mb-5 opacity-90 relative z-10 leading-relaxed">Get 20% off on all Vitamins & Supplements. Limited time only.</p>
